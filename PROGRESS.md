...
- **Branch/Run**: `chore/project_state_refresh` (RUN_NAME=`20251222_205400_project_state_rebuild`), git sha `d78a128f29d24e92e5f0e9c2332e388c8b22c1d1`.
- **Commands**: `python3 tools/generate_project_state.py`; `python3 - <<'PY'` (emit FUNCTION_INDEX/DEPENDENCY_GRAPH); `python3 - <<'PY'` (write project_state docs); `zip -r docs/gpt_bundles/project_state_20251222_205400_d78a128.zip ...`.
...
- **Artifacts**: run log `docs/agent_runs/20251222_205400_project_state_rebuild/`; bundle `docs/gpt_bundles/project_state_20251222_205400_d78a128.zip`.
