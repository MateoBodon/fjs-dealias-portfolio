...
- 2026-01-26: FJS-TKT-029 gpt-bundle dirty-repo guard + git_dirty bundle meta. Tests: `. .venv/bin/activate && make test-fast && pytest -q tests/test_gpt_bundle.py`. Artifacts: `docs/agent_runs/20260126_050923_ticket-29_gpt-bundle-dirty-check/`, `docs/gpt_bundles/20260126_052458_FJS-TKT-029_20260126_050923_ticket-29_gpt-bundle-dirty-check.zip`.
- 2026-01-26: FJS-TKT-028 inject-spike telemetry + between-mode default + smoke. Tests: `. .venv/bin/activate && make test-fast`, `. .venv/bin/activate && pytest -q tests/experiments/test_inject_spike.py`. Artifacts: `docs/agent_runs/20260126_031452_ticket-028_inject-spike-telemetry/`, `reports/inject_spike_smoke/20260126_043000_ticket-028_inject-spike-smoke/`, `reports/inject_spike_smoke/20260126_045000_ticket-028_inject-spike-smoke-mini/`, `docs/gpt_bundles/20260126_042939_FJS-TKT-028_20260126_031452_ticket-028_inject-spike-telemetry.zip`.
- 2026-01-26: FJS-TKT-027 week eval artifacts (run.json/run.log staging + early-exit test). Tests: `python3 -m venv .venv && source .venv/bin/activate && make setup && make test-fast && pytest -q tests/experiments/test_eval_week_artifacts.py`. Artifacts: `docs/agent_runs/20260126_022651_ticket-27_week-eval-artifacts/`, `docs/gpt_bundles/20260126_023201_FJS-TKT-027_20260126_022651_ticket-27_week-eval-artifacts.zip`.
- 2026-01-26: FJS-TKT-026 project_state refresh + runbook updates. Tests: `make test-fast` (failed: pytest not found). Artifacts: `docs/agent_runs/20260126_010603_ticket-26_project-state-refresh/`, `docs/_bundles/project_state_20260126_001250.zip`.
