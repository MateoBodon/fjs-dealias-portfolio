...
- **2025-12-17 (later)** — Added nested skip-reason logging and tests; extended Tyler/Huber calibrated delta grid to p≈188–200, T≈60–80; merged calibration updates into `calibration/edge_delta_thresholds.json`; introduced nested synthetic kill-test harness/config and recorded FPR≈1 null failure; rc-lite-sanity summary now surfaces overlay harm flags for daily DoW/vol; refreshed CURRENT_RESULTS/KNOWN_ISSUES accordingly.
