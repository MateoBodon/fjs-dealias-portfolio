...
- **Nested synthetic kill-test (20251218)** — `reports/synthetic_nested_killtest/post_null_20251218/summary.md` and `reports/synthetic_nested_killtest/post_smoke_20251218/summary.md`: tightened gating (use_tvector on, eps=1.0, eta=0.3°, off_leak=0.3, isolated filter) drives null detection_rate to 0/220 while keeping power on strong spikes (strong=1.0, moderate≈0.42 over 12 trials); skip reasons recorded as `no_isolated_spike`, calibration present.
- **Gaps**
