...
- **M4 v3 closes the local boundary/invariance definitions but remains
  externally fail-closed**: the cell-specific independent boundary, hash-bound
  four-transform reducer, exact v3 runner path, and canonical full/smoke
  manifests are now frozen and replayable. Full execution still requires
