...
- **Guardrail attribution unclear** — RESOLVED in ticket-09: gating diagnostics now emit explicit skip_reason_primary/detail plus exception_type/stage/message_short; `guard_other` is unreachable in smokes (0 counts) and diagnostic_failure rows include exception context. Monitor future smokes for regressions.
