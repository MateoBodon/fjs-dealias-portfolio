...
- Delta MSE (EW) < 0 in 29.1% of comparisons (median Delta MSE (EW) = 1.666e-07).
- 5 of 15 Diebold–Mariano tests show p < 0.05.
- 37 of 48 QLIKE DM tests show p < 0.05.
- Accepted detections substitute in 54.9% of evaluated windows.
- Median alignment angle across runs: 17.5° (mean 25.3°).
